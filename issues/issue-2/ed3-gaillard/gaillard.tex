 \documentclass[editorial,noabstract ,authordate,twocolumn,issue]{jote-new-article}
...
\author[1,2]{Stefan Gaillard}
\author[3]{Sean Devine}

\affil[1]{Institute for Science in Society, Radboud University, Nijmegen, Netherlands}
\affil[2]{Center for Education, University Medical Center Utrecht, Utrecht, Netherlands}
\affil[3]{The Otto Lab, Department of Psychology, McGill University, Montreal, Quebec, Canada}
\jpages{1-5}
...
\runningauthor{Gaillard and Devine}
...
\paperissued{March 3, 2022}

\paperpublished{March 3, 2022}
...
The authors would like to thank \href{https://oliviodare.com}{Max Bautista Perpinyà} for his substantial comments on the first draft, especially concerning the systemic approach, which led to a complete overhaul and ultimately improvement of the article.
\printbibliography
